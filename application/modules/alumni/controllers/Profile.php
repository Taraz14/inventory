...
class Profile extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('alumni/profile_model', 'profile');
    ...
    {
        $userData = $this->session->userdata();
        $data['content']  = 'update_profile';
        $data['active']   = 'profile';
        $data['title']    = 'ALUMNI SD 1 - Admin';
        $data['head']       = 'Ubah Profile';
        $data['breadcrumb'] = '<a href="'.site_url("1/profile").'">Profile</a> <li class="breadcrumb-item active"> Ubah Data</li>';
        $data['userData'] = $userData;
        $this->load->view("layouts/wrapper", $data);
    }
    ...
    private function actionUpdate()
    {
        ...
        if(!$this->profile->update($data, $params)) {
            return direct("1/update-profile", "Gagal update profil");
        }
        ...
        return direct("1/profile", "Berhasil update profil");
    }
