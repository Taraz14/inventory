...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-dark-info">
    ...
    <a href="<?= site_url('0/dashboard')?>" class="brand-link">
      <img src="<?= base_url('assets/dist/img/logo.svg')?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= (empty($this->session->photo)) ? base_url('assets/dist/img/nophoto.png') : base_url($this->session->userdata('photo')); ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= site_url('0/galeri')?>" class="nav-link <?= ($sessi == 'galeri') ? 'active' : ''; ?>">
          ...
          <li class="nav-item">
            <a href="<?= site_url('0/rekap')?>" class="nav-link <?= ($sessi == 'rekap') || ($sessi == 'detail-rekap') ? 'active' : ''; ?>">
